    ...
    <div className="dashboard-container">
      ...
      {profile?.medical_history && (
        <div style={{
          ...
          borderRadius: 0, padding: '1.25rem 1.5rem', marginBottom: '2rem',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {records.map(r => (
            <div key={r.record_id} className="dashboard-section" style={{
              ...
              <div style={{ background: 'var(--bg-main)', padding: '0.75rem', fontSize: '0.875rem', color: 'var(--text-secondary)', marginBottom: '0.5rem' }}>
                <strong>💊 Prescription:</strong> {r.prescription}
              </div>
              {r.test_reports && (
                <div style={{ background: 'var(--bg-hover)', padding: '0.75rem', fontSize: '0.875rem', color: 'var(--brand-primary)' }}>
